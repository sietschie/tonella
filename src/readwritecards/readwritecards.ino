/**
 * write increasing number so first byte of block 4 on each presented card
 *
 * ----------------------------------------------------------------------------
...
void setup() {
  ...
  Serial.println(
      F("Scan a MIFARE Classic PICC to demonstrate read and write."));
